...
5. Анимации при изменении, анимации при наведении.
6. При наведении на блок, начинается анимация, при клике - эффект material wave
...
6. Можно сразу посмотреть результат по [ссылке](https://tbex.vercel.app/)
